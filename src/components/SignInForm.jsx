        ...
        <>
            <div className="flex flex-col justify-start gap-14 p-8 items-center md:w-2/3 ">
                ...
                <form className="flex flex-col gap-5 w-full p-5">
                    ...
                    <input type="text" placeholder='Email' className='h-10 p-3 rounded-xl focus:bg-indigo-100 focus:border-none' />
                    <div className='text-left font-lato text-md text-black'>
                        Password
                    </div>
                    <input type="password" placeholder="Password" className='h-10 p-3 rounded-xl focus:bg-indigo-100 focus:border-none' />
                    <div className='text-left font-lato text-md text-baseBlue cursor-pointer'>
                        Forgot Password?
                    </div>
                    <button className="flex-1 font-bold bg-baseBlue text-white py-2 rounded-xl ">Sign In</button>
                </form>
